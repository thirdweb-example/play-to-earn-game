...
// File: contracts/miningGame/lib/BlackHolePrevention.sol
...
// File: contracts/miningGame/passId.sol
...
// File: contracts/miningGame/axes.sol
...
// File: contracts/miningGame/earlyPioneersFlattened.sol


pragma solidity ^0.8.4;

//ADD ROYALTIESSSSSSSSSSSSSSS
//CHECK SOULBOUND TOKENS AGAINN
...
contract earlyCaliforniaPioneer is ERC721A, Ownable, ReentrancyGuard, BlackholePrevention{
    ...
    mapping(address => mapping( uint => bool ))public ownerOfId;
  ...
  mapping (address => AXE) public axe;
    ...
    */
      ...
      require(totalSupply() + 1 <= MAX_SUPPLY_PROJECT, "Not enough tokens left for public");
      require(msg.value >= mintRate, "Not enough ether sent");
      _safeMint(msg.sender, 1);
      ownerOfId[msg.sender][_currentIndex] = false;
      //ERC721A._nextTokenId();
    ...
    function stakeAxe(uint256 _tokenId) external nonReentrant {
        ...
        axes.safeTransferFrom(address(this), msg.sender, axe[msg.sender].id, 1, "Returning your axe");
        }
...
//******************************SET FUNCTIONS**************************
    ...
    */
    ...
    function setMaxAmount(uint32 _maxAmount) external onlyOwner {
