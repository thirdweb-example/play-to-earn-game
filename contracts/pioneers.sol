...
contract CaliforniaPioneers is ERC721A, Ownable, ReentrancyGuard{
    uint256 MAX_MINTS = 1;
    uint256 MAX_SUPPLY_PUBLIC = 9000;
    uint256 MAX_SUPPLY_PROJECT = 10000;
...
*/
    ...
    constructor() ERC721A("California Pioneers", "Wellcome to Paydirt! Wanna have fun? y/n") {
